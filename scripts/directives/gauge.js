dashboard.directive("gauge", function() {
    return {
        ...
        template: function(e, attrs) {
            // returns the HTML or SVG that displaces the original gauge element
            return '<svg xmlns="http://www.w3.org/2000/svg" width="600" height="600">' +
                ...
                '</text>' +
                '<text x="{{maxValueCoordinates.x}}" y="{{maxValueCoordinates.y}}" text-anchor="middle" style="font: bold large arial" transform="rotate( 90,{{maxValueCoordinates.x}},{{maxValueCoordinates.y}})">{{specs.maxValue}}</text>' +
                '</svg>';
        },
